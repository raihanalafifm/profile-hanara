        ...
        <table class="table table-hover">
            ...
            <tbody class="table-border-bottom-0">
                ...
                <tr>
                    ...
                    <td>
                        @if($product->image)
                            <img src="{{ Storage::url($product->image) }}" alt="{{ $product->name }}" style="height: 50px; width: auto;">
                        @else
                    ...
                    <td>
                        <form action="{{ route('backend.motorola.toggle-status', $product) }}" method="POST" class="d-inline">
                            @csrf
                            @method('PATCH')
                            <button type="submit" class="btn btn-sm btn-{{ $product->is_active ? 'success' : 'secondary' }}">
            ...
            <form action="{{ route('backend.motorola.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" id="name" name="name" class="form-control @error('name') is-invalid @enderror" 
                                   placeholder="e.g. XIR P3688" required>
                            @error('name')
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" id="model_number" name="model_number" class="form-control @error('model_number') is-invalid @enderror" 
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="specifications" name="specifications" class="form-control @error('specifications') is-invalid @enderror" 
                                  rows="6" placeholder="Format per baris:&#10;Frequency Range: 136-174 MHz&#10;Power Output: 5W&#10;Channels: 16"></textarea>
            ...
            <form id="editMotorolaForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" id="edit_image" name="image" class="form-control" accept="image/jpeg,image/png,image/jpg">
