      ...
      <div class="col-lg-5 mb-4 mb-lg-0">
        <div class="hnr-zimbra-logo-container">
          <img src="{{ asset('assets/images/icon/zimbra instalasi.png') }}" 
               alt="Instalasi Zimbra Mail Server - PT Hanara Prima Solusindo" 
               class="hnr-zimbra-logo"
               loading="lazy"
               width="400"
               height="400">
        </div>
      ...
      <div class="col-lg-7">
        <div class="hnr-zimbra-content">
          ...
          <div class="hnr-zimbra-features">
            ...
            <div class="hnr-zimbra-feature-item">
              <span class="hnr-feature-bullet">•</span> <strong>Task:</strong> Mengelola dan membantu pekerjaan dengan lebih terstruktur.
            </div>
            <div class="hnr-zimbra-feature-item">
              <span class="hnr-feature-bullet">•</span> <strong>Briefcase:</strong> Menyimpan dan berbagi file pekerjaan secara aman.
            </div>
            <div class="hnr-zimbra-feature-item">
          ...
          <div class="row mt-4">
            ...
            $features = [
                [
                    ...
                    'title' => 'Open Source',
                    'description' => 'Zimbra sangat cocok untuk digunakan sebagai email on-premise karena anda dapat mengembangkan platform ini sesuai kebutuhan.'
                ],
                [
                    'icon' => 'icon-fitur-2.png',
                    'title' => 'Operating System Linux',
                    'description' => 'Zimbra adalah platform email yang stabil dan aman karena berjalan diatas sistem operasi Linux, khususnya CentOS dan Ubuntu.'
                ],
                [
                    'icon' => 'icon-fitur-3.png',
                    'title' => 'Class of Service',
                    'description' => 'Mengelola fasilitas untuk user dan mengelompokan user menjadi sangat mudah dengan fitur Class of Services di Admin Console Zimbra.'
                ],
                [
                    'icon' => 'icon-fitur-4.png',
                    'title' => 'Admin Console',
                    'description' => 'Anda tidak perlu menguasai dan memahami command, karena Zimbra sudah menyediakan Administration Console berbasis web.'
                ],
                [
                    'icon' => 'icon-fitur-5.png',
                    'title' => 'Mobile Device Management',
                    'description' => 'Fitur yang dapat mengamankan data data Anda melalui webmail ketika Anda kehilangan device smartphone.'
                ],
                [
                    'icon' => 'icon-fitur-6.png',
                    'title' => 'CBPOLICYCD',
                    'description' => 'Mengatur berbagai macam policy users untuk kirim dan terima email menggunakan CBPolicyD berbasis web.'
                ],
                [
                    'icon' => 'icon-fitur-7.png',
                    'title' => 'Active Sync',
                    'description' => 'Sinkronisasikan account email Anda dengan smartphone menggunakan Active Sync. Sinkronisasi data data email, kontak, task, dan kalender.'
                ],
                [
                    'icon' => 'icon-fitur-8.png',
                    'title' => 'Fitur Zimlet',
                    'description' => 'Lengkapi kebutuhan pekerjaan anda dengan tools yang disediakan Zimlet untuk webmail Zimbra.'
                ]
            ];
            @endphp
              ...
              <div class="hnr-feature-card" itemscope itemtype="https://schema.org/Product">
                <div class="hnr-feature-icon">
                  <img src="{{ asset('assets/images/icon/' . $feature['icon']) }}" 
                       alt="{{ $feature['title'] }} - Fitur Zimbra" 
                       loading="lazy"
                       width="10"
                       height="10">
                </div>
        ...
        <div class="hnr-comparison-section">
          ...
          <div class="hnr-comparison-table">
            ...
            <div class="hnr-comparison-content">
              @php
              $comparisons = [
                  ['zimbra' => 'IP Public terpisah dari website', 'hosting' => 'IP Public sharing dengan website'],
                  ['zimbra' => 'Tampilan menarik, tersedia banyak tema', 'hosting' => 'Tampilan kaku, pilihan tema sedikit'],
                  ['zimbra' => 'Webmail dilengkapi banyak fitur', 'hosting' => 'Webmail hanya untuk send and received email'],
                  ['zimbra' => 'Quota user bisa dicustom', 'hosting' => 'Quota user hanya 2 opsi'],
                  ['zimbra' => 'Bisa mengelompokan user (Class of Services)', 'hosting' => 'Tidak bisa mengelompokan user'],
                  ['zimbra' => 'Bisa trace email melalui log', 'hosting' => 'Tidak bisa trace email']
              ];
              @endphp
      ...
      <div class="col-12">
        <div class="hnr-protocol-section">
          ...
          <div class="row mt-4">
            @php
            $protocols = [
                ['number' => '01', 'title' => 'SMTP (Simple Mail Transport Protocol)', 'desc' => 'Digunakan untuk mengirim email antar server.'],
                ['number' => '02', 'title' => 'SSMTP (Secure Simple Mail Transport Protocol)', 'desc' => 'Versi aman dari SMTP dengan enkripsi SSL/TLS.'],
                ['number' => '03', 'title' => 'POP3 (Post Office Protocol)', 'desc' => 'Mengambil email dari server ke klien dan menghapusnya dari server.'],
                ['number' => '04', 'title' => 'POP3S (Secure Post Office Protocol)', 'desc' => 'POP3 dengan koneksi yang dienkripsi menggunakan SSL/TLS.'],
                ['number' => '05', 'title' => 'IMAP (Internet Mail Application Protocol)', 'desc' => 'Mengelola email langsung di server tanpa menghapus salinan.'],
                ['number' => '06', 'title' => 'IMAPS (Secure Internet Mail Application Protocol)', 'desc' => 'IMAP yang dilengkapi dengan koneksi aman melalui SSL/TLS.']
            ];
            @endphp
