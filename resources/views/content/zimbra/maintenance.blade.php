                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="hnr-manfaat-item">
                                    ...
                                    <p class="hnr-manfaat-item-text">
                                        Sistem Operasi adalah fondasi dari Zimbra Mail Server. Zimbra sangat bergantung
                                        dengan kestabilan sistem operasi, dengan berlangganan support atau maintenance
                                        Zimbra, kami akan selalu memastikan bahwa sistem operasi yang anda gunakan dalam
                                        status normal.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="hnr-manfaat-item">
                                    ...
                                    <p class="hnr-manfaat-item-text">
                                        Kami memahami bahwa dalam dunia jaringan komputer dan internet, kemungkinan cyber
                                        attack sangatlah besar. Bagaimanapun juga kita memiliki email server, oleh karena
                                        itu aspek keamanan merupakan hal yang krusial dan rutin harus di cek.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="hnr-manfaat-item">
                                    ...
                                    <p class="hnr-manfaat-item-text">
                                        Log merupakan suatu record yang merekam semua aktivitas dari services yang berjalan.
                                        Dengan aktifitas rutin memeriksa log pada server, kita dapat mengetahui lebih awal
                                        apabila terjadi sebuah masalah untuk segera di "solve" sebelum masalah tersebut
                                        fatal.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="hnr-manfaat-item">
                                    ...
                                    <p class="hnr-manfaat-item-text">
                                        Setelah semua kegiatan preventive dilakukan, kami akan tuangkan itu semua kedalam
                                        report yang bisa Anda pahami, sehingga Anda bisa membaca bagaimana kondisi server,
                                        termasuk kami memberikan rekomendasi apa saja yang harus dilakukan dari hasil
                            ...
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="hnr-manfaat-item">
                                    ...
                                    <p class="hnr-manfaat-item-text">
                                        Kami memberikan performa dan keamanan terbaik, serta berlangsungnya fitur fitur
                                        baru, maka sangat diperlukan untuk melakukan update versi atau patching baik itu
                                        update sistem operasi maupun update versi dari Zimbra Mail Server.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="hnr-manfaat-item">
                                    ...
                                    <p class="hnr-manfaat-item-text">
                                        Zimbra memiliki banyak services yang digunakan, diantaranya LDAP, Mailbox, Proxy dan
                                        MTA sebagai service wajib untuk platform email. Seluruh hal fitur jika salah satu
                                        saja service tersebut ada yang not running, oleh karena itu kami melakukan
                                        monitoring dan daily check.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-4 justify-content-center">
                            ...
                            <div class="col-md-6 col-lg-5 mb-4">
                                <div class="hnr-manfaat-item">
                                    ...
                                    <p class="hnr-manfaat-item-text">
                                        Kami memberikan jaminan quick respon dengan durasi respon maksimal 1 x 30 menit saat
                                        gangguan ditujukan melalui media chat ataupun email. Anda tidak perlu khawatir
                                        ketika terjadi masalah dengan Zimbra, tim kami akan segera melakukan pengecekan dan
                                        solving problem.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-5 mb-4">
                                <div class="hnr-manfaat-item">
                                    ...
                                    <p class="hnr-manfaat-item-text">
                                        Dengan berlangganan support atau maintenance Zimbra dari kami, tentu Anda tidak
                                        perlu lagi merekrut mahal gaji karyawan yang dapat mengelola email server Anda.
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row mt-5">
                <div class="col-12">
                    <div class="hnr-layanan-section">
                        ...
                        <p class="hnr-layanan-subtitle">Solusi maintenance terbaik untuk memastikan Zimbra Anda tetap andal.
                        </p>
