            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="hnr-article-card">
                    <div class="hnr-article-image">
                        ...
                        @else
                            <img src="{{ asset('assets/images/icon/icon hanara.png') }}" alt="{{ $related->title }}">
                        @endif
                    </div>
                    <div class="hnr-article-content">
                        ...
                        @if($related->link)
                        <a href="{{ $related->link }}" class="hnr-article-link" target="_blank" rel="noopener">
                            LANJUT BACA <i class="bi bi-arrow-right"></i>
                        </a>
                        @else
                        <a href="{{ route('articles.show', Str::slug($related->title) . '-' . $related->id) }}" class="hnr-article-link">
                            LANJUT BACA <i class="bi bi-arrow-right"></i>
                        </a>
                        @endif
                    </div>
