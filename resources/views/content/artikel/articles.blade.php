            ...
            <div class="row mb-5">
                <div class="col-lg-8">
                    <form action="{{ route('articles.index') }}" method="GET" class="hnr-articles-search-form">
                        <div class="input-group">
                            <input type="text" class="form-control hnr-search-input" placeholder="Cari artikel..."
                ...
                <div class="col-lg-4">
                    <select class="form-select hnr-category-filter" onchange="filterByCategory(this.value)">
                        ...
                        <option value="solusi" {{ request('category') == 'solusi' ? 'selected' : '' }}>Solusi Teknologi
                            Bisnis</option>
                        <option value="kasus" {{ request('category') == 'kasus' ? 'selected' : '' }}>Studi Kasus Klien
                        </option>
                        <option value="tips" {{ request('category') == 'tips' ? 'selected' : '' }}>Tips & Panduan IT
                        </option>
                        ...
                        <div class="col-12">
                            <nav aria-label="Articles pagination">
                                <ul class="pagination justify-content-center hnr-pagination">
                                    ...
                                    @else
                                        <li class="page-item"><a class="page-link" href="{{ $articles->previousPageUrl() }}"
                                                rel="prev">‹</a></li>
                                    @endif
                                    ...
                                    @if ($articles->hasMorePages())
                                        <li class="page-item"><a class="page-link" href="{{ $articles->nextPageUrl() }}"
                                                rel="next">›</a></li>
                                        <li class="page-item"><a class="page-link"
                                                href="{{ $articles->url($articles->lastPage()) }}">Last</a></li>
                                    @else
                                        <li class="page-item disabled"><span class="page-link">›</span></li>
                                    @endif
                                </ul>
