    ...
    <div class="row">
      ...
      <div class="col-lg-5 mb-4">
        <div class="hnr-product-image-container">
          @if($product->image)
            <img src="{{ Storage::url($product->image) }}" alt="{{ $product->name }}" class="hnr-product-main-image">
          @else
            <img src="{{ asset('assets/images/gambar/PRODUK MOTOROLA/default.png') }}" alt="{{ $product->name }}" class="hnr-product-main-image">
          @endif
      ...
      <div class="col-6 col-md-3 mb-4">
        <div class="hnr-related-product-card">
          <div class="hnr-related-product-image">
            ...
            @else
              <img src="{{ asset('assets/images/gambar/PRODUK MOTOROLA/default.png') }}" alt="{{ $related->name }}">
            @endif
          </div>
