    ...
    <section class="hnr-webapp-section">
        <div class="container ">
            ...
            <div class="row mb-5">
                ...
                <div class="col-md-6 mb-5 reveal-section">
                    <div class="hnr-webdev-service-card">
                        ...
                        <div class="hnr-webdev-service-content">
                            <h3 class="hnr-webdev-service-title">Aplikasi internal perusahaan dan startup
                            </h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 mb-5 reveal-section">
                    <div class="hnr-webdev-service-card">
                        ...
                        <div class="hnr-webdev-service-content">
                            <h3 class="hnr-webdev-service-title">Sistem informasi sekolah dan yayasan
                            </h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 mb-5">
                    <div class="hnr-webdev-service-card reveal-section">
                        <div class="hnr-nextcloud-service-icon">
                            <img src="{{ asset('assets/images/icon/icon-fitur-5.png') }}" alt="akses mudah"
                                class="img-fluid">
                        </div>
                        <div class="hnr-webdev-service-content">
                            <h3 class="hnr-webdev-service-title">Web portal layanan publik dan pemerintahan
                            </h3>
                ...
                <div class="col-md-6 mb-5">
                    <div class="hnr-webdev-service-card reveal-section">
                        <div class="hnr-nextcloud-service-icon">
                            <img src="{{ asset('assets/images/icon/icon-fitur-7.png') }}" alt="akses mudah"
                                class="img-fluid">
                        </div>
                        <div class="hnr-webdev-service-content">
                            <h3 class="hnr-webdev-service-title">Platform bisnis berbasis cloud / SaaS
                            </h3>
                            {{-- <p class="hnr-nextcloud-service-desc">
                                Tersedia aplikasi Nextcloud untuk Windows, macOS, Android, dan iOS, memudahkan kolaborasi
                                lintas perangkat.
                ...
                <div class="row mb-5 align-items-center reveal-section">
                    ...
                    <div class="col-md-9">
                        ...
                        <p class="hnr-webapp-framework-desc">
                            ...
                            seluruh dunia dalam membangun aplikasi web. Sebuah framework yang dapat memaksimalkan penggunaan
                            PHP
                        ...
                        <div class="hnr-webapp-framework-features">
                            ...
                            <ol class="hnr-webapp-features-list">
                                ...
                                <li>Framework ini lebih menghemat waktu karena Laravel dapat disinkronisasikan dengan
                                    framework
                                    lain.</li>
                            </ol>
                        </div>
                ...
                <div class="row mb-5 align-items-center reveal-section">
                    <div class="col-md-9 order-md-1 order-2">
                        ...
                        <p class="hnr-webapp-framework-desc">
                            ...
                            control-control yang membantu kita untuk membuat sebuah aplikasi yang professional dari segi
                            user
                        ...
                        <div class="hnr-webapp-framework-features">
                            ...
                            <ol class="hnr-webapp-features-list">
                                <li>LayoutControl DevExpress memungkinkan Anda mengatur item sebagai tab dalam grup atau
                                    yang
                                    berbeda.</li>
                ...
                <div class="row mb-5 align-items-center reveal-section">
                    <div class="col-md-3 text-center mb-4 mb-md-0">
                        <div class="hnr-webapp-framework-logo">
                            <img src="{{ asset('assets/images/icon/codeigniter.png') }}" alt="CodeIgniter"
                                class="img-fluid">
                        </div>
                    </div>
                    <div class="col-md-9">
                        ...
                        <p class="hnr-webapp-framework-desc">
                            ...
                            berbasis PHP berdasarkan package serta array library yang lebih luas. Sehingga web developer
                            menjadi
                        ...
                        <div class="hnr-webapp-framework-features">
                            ...
                            <ol class="hnr-webapp-features-list">
                                <li>Framework ini diklaim memiliki performa yang sangat cepat dibanding framework-framework
                                    lain.</li>
                                <li>Penggunaan resourcenya yang kecil, hanya memerlukan spesifikasi server/hosting yang
                                    kecil
                                    dibandingkan dengan framework lain.</li>
                                <li>CodeIgniter bersifat tidak kaku, sehingga memberikan kebebasan kepada web developer
                                    untuk
                ...
                <div class="row mt-4 mb-5 reveal-section">
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="hnr-webapp-benefit-card">
                            ...
                            <p class="hnr-webapp-benefit-desc">
                                Tersedia jasa pembuatan web custom menyesuaikan permintaan pada, sehingga menghasilkan web
                                yang
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="hnr-webapp-benefit-card">
                            ...
                            <p class="hnr-webapp-benefit-desc">
                                Anda tidak perlu ragu dan khawatir, karena kami memiliki Tim yang ahli dan berpengalaman
                                untuk
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="hnr-webapp-benefit-card">
                            ...
                            <p class="hnr-webapp-benefit-desc">
                                Kami membangun platform yang didesain sedemikian rupa agar menjadi website yang
                                user-friendly,
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="hnr-webapp-benefit-card">
                            ...
                            <p class="hnr-webapp-benefit-desc">
                                Selain menghasilkan web berkualitas, kami juga memberikan harga terbaik dimana resource
                                termasuk
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="hnr-webapp-benefit-card">
                            ...
                            <p class="hnr-webapp-benefit-desc">
                                Memastikan bahwa tampilan layout website berjalan dengan baik pada ponsel, tablet atau
                                perangkat
