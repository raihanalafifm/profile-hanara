    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg-5 mb-4 mb-lg-0">
        <div class="hnr-house-maint-logo-container">
          <img src="{{ asset('assets/images/icon/maintenance-web.png') }}" alt="Website Maintenance" class="hnr-house-maint-logo">
        </div>
      </div>
          ...
          <div class="row mt-4">
              ...
              <div class="hnr-house-benefit-item">
                <div class="hnr-house-benefit-icon-container">
                  <div class="hnr-house-benefit-icon">
                    <img src="{{ asset('assets/images/icon/icon-web-maintenance1.png') }}" alt="Software & Plugin Outdated">
                  </div>
                </div>
            ...
            <div class="col-md-6 col-lg-3 mb-4">
              <div class="hnr-house-benefit-item">
                <div class="hnr-house-benefit-icon-container">
                  <div class="hnr-house-benefit-icon">
                    <img src="{{ asset('assets/images/icon/icon-web-maintenance2.png') }}" alt="Performa Website">
                  </div>
                </div>
            ...
            <div class="col-md-6 col-lg-3 mb-4">
              <div class="hnr-house-benefit-item">
                <div class="hnr-house-benefit-icon-container">
                  <div class="hnr-house-benefit-icon">
                    <img src="{{ asset('assets/images/icon/icon-web-maintenance4.png') }}" alt="Konten Outdated">
                  </div>
                </div>
            ...
            <div class="col-md-6 col-lg-3 mb-4">
              <div class="hnr-house-benefit-item">
                <div class="hnr-house-benefit-icon-container">
                  <div class="hnr-house-benefit-icon">
                    <img src="{{ asset('assets/images/icon/icon-web-maintenance3.png') }}" alt="Data Hilang">
                  </div>
                </div>
        ...
        <div class="hnr-house-expertise-section">
          ...
          <div class="row mt-4">
            ...
            <div class="col-md-6 mb-4">
              <div class="hnr-house-expertise-card">
                <div class="hnr-house-expertise-icon">
                  <img src="{{ asset('assets/images/icon/icon-fitur-3.png') }}" alt="Tim Professional">
                </div>
            ...
            <div class="col-md-6 mb-4">
              <div class="hnr-house-expertise-card">
                <div class="hnr-house-expertise-icon">
                  <img src="{{ asset('assets/images/icon/icon-card-maintenance1.png') }}" alt="Optimalisasi Performa">
                </div>
                <div class="hnr-house-expertise-content">
            ...
            <div class="col-md-6 mb-4">
              <div class="hnr-house-expertise-card">
                <div class="hnr-house-expertise-icon">
                  <img src="{{ asset('assets/images/icon/icon-card-maintenance7.png') }}" alt="Fast Support">
                </div>
                <div class="hnr-house-expertise-content">
            ...
            <div class="col-md-6 mb-4">
              <div class="hnr-house-expertise-card">
                <div class="hnr-house-expertise-icon">
                  <img src="{{ asset('assets/images/icon/icon-card-maintenance2.png') }}" alt="Security Updates">
                </div>
                <div class="hnr-house-expertise-content">
